...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() async {
    var db = await mongo.Db.create("mongodb+srv://Cluster2User:gPId3Gm4a0I9icN5@agile2cluster.bxvcw4l.mongodb.net/Test?retryWrites=true&w=majority");
    ...
    var mycol = await collection.find().toList();
    print(mycol);
    setState(()  {
      text = mycol;
      _counter++;
        ...
        child: SingleChildScrollView(
          child: Column(
            children: List.generate(text.length, (index) {
              return ListTile(
                title: Text(text[index]['name'].toString()),
              );
            }),
          ),
        )
